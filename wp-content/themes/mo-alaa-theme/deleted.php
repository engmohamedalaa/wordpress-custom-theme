<?php
// echo '<pre>';
// var_dump(wpdb_get_all_meta('hero_image_src', $current_page_id));
// echo '</pre>';
//style="background-image:url('<?php echo get_post_meta($current_page_id, 'hero_image_src', true);');" ?>
        ...
        <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
            ...
            <div class="portfolio-item">
                <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                    ...
                    <img class="img-fluid" src="<?php echo get_template_directory_uri();?>/assets/img/portfolio/5.jpg" alt="..." />
                </a>
                <div class="portfolio-caption">
        ...
        <div class="col-lg-4 col-sm-6">
            ...
            <div class="portfolio-item">
                <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal6">
                    ...
                    <img class="img-fluid" src="<?php echo get_template_directory_uri();?>/assets/img/portfolio/6.jpg" alt="..." />
                </a>
                <div class="portfolio-caption">
